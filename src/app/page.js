    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white">
      ...
      <div className="flex flex-col items-center justify-center p-8">
        <div className="bg-white/80 backdrop-blur-sm rounded-lg p-8 max-w-4x1 mx-auto flex flex-col md:flex-row items-center gap-8">
          {/* Profile Picture */}
          <div className="w-32 h-32 md:w-200 md:h-100 relative">
            <Image
              src="/profile.jpg"
              alt="Profile Picture"
              fill
          ...
          <div className="text-center md:text-left">
            ...
            <p className="text-lg mb-6">
              Hi, I&#39;m Tomiwa Ogunleye, a highly motivated and detail-oriented Software Developer with a Bachelor of Science in Computer Science from the University of Regina. I have proven expertise in developing scalable, maintainable, and reliable code, with a strong commitment to continuous learning and applying software engineering best practices.
            </p>
            <Link
              href="/projects"
